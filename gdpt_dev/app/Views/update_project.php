...
<div class="container mt-4">
    ...
    <form id="formProjet">
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="num_projet" name="num_projet" required readonly>
                </div>
        ...
        <div class="text-center mt-4">
            <button type="submit" class="btn btn-primary" id="btnModifierProjet">Modifier</button>
        </div>
    </form>
</div>
